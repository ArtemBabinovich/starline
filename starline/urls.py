...
from . import views
from .views import layout, CatalogView, AllProductView, DetailProductView, CommentView, ActionView, OurWorkView, \
    phone_form_view

urlpatterns = [
    path('', layout, name='layout'),
    path('feedback/', phone_form_view, name='phone_submit'),
